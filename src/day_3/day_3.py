...
def part_one():
    ...
    for line in get_input_lines():
        ...
        left_comparment = items[:items_per_comparment] #remember the last number is exclusive
        right_compartment = items[items_per_comparment:]

        # Convert each string to a set of characters, to remove duplicates
        left_compartment_set = set(left_comparment)
        right_compartment_set = set(right_compartment)
